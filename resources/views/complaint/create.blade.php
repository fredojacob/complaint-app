...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Quejas</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('complaint.store') }} ">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="complaint" type="" class="form-control @error('complaint') is-invalid @enderror" name="complaint" required autocomplete="complaint">
